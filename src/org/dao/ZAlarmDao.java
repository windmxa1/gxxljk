...
public interface ZAlarmDao {
	 ...
	 */
	public List getAlarmList(Integer start, Integer limit, Integer type,Long userid);
	 ...
	 * 8.获取指定时间段的数据的数目
	 */
	public Long getAlarmCount(Integer type, String start_time, String end_time,Long userid);
